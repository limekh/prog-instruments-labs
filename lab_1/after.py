...
def rules():
    ...
    print("The positions of this 3 x 3 board is same as "
          "the right side of your key board.\n")
    print(" 7 | 8 | 9 ")
    print("-----------")
    print(" 4 | 5 | 6 ")
    print("-----------")
...
def player_choice(board, name, choice):
    ...
    while (position not in [1, 2, 3, 4, 5, 6, 7, 8, 9]
        ...
        position = int(input(f'\n{name} ({choice}),'
                             f' Choose your next position: (1-9) \t'))
...
def comp_ai(board, name, choice):
    ...
    # including both X and O, since if computer will win,
    # he will place a choice there,
...
def win_check(board, choice):
    ...
    return (
            ...
            or (board[4] == choice and board[5] == choice
                and board[6] == choice)
            or (board[7] == choice and board[8] == choice
                and board[9] == choice)
            # VERTICAL CHECK;
            or (board[1] == choice and board[4] == choice
                and board[7] == choice)
            or (board[2] == choice and board[5] == choice
                and board[8] == choice)
            or (board[3] == choice and board[6] == choice
                and board[9] == choice)
            # DIAGONAL CHECK;
            or (board[1] == choice and board[5] == choice
                and board[9] == choice)
            or (board[3] == choice and board[5] == choice
                and board[7] == choice))
...
while True:
    ...
    if (mode == 2):
        ent = input("\nThis is going to be fast!"
                    " Press Enter for the battle to begin!\n")
        play_game = 1
    else:
        play_game = play()
